...
const complaints: Record<string, TextKey> = {
  ...
  "port-busy": "error.portHeld",
  "no-module": "error.noModule",
  "no-rights": "error.noRights",
  "forwarding-off": "error.forwardingOff",
  ...
  "bad-client-routes": "error.badClientRoutes",
  ...
  "subscription-path-taken": "error.subscriptionPathTaken",
  "bad-subscription-interval": "error.badSubscriptionInterval",
  "bad-subscription-title": "error.badSubscriptionTitle",
  "subscription-port-busy": "error.subscriptionPortBusy",
  "subscription-failed": "error.subscriptionFailed",
  ...
  "bad-offline-after": "error.badOfflineAfter",
  ...
  "outbound-in-use": "error.outboundInUse",
  ...
  "bad-rule-client": "error.badRuleClient",
  "bad-rule-inbound": "error.badRuleInbound",
  "bad-source-port": "error.badSourcePort",
  "unknown-inbound": "error.unknownInbound",
  "bad-test-target": "error.badTestTarget",
