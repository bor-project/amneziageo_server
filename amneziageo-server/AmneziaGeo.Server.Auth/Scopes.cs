...
public static class Scopes
{
    ...
    public const string ReadBackup = "backup:read";
    ...
    /// </summary>
    public static readonly string[] All = [ReadState, ManageClients, ManageInterfaces, ManageRouting, ManageAccess, ManageUpdates, ReadBackup];
