...
namespace AmneziaGeo.Server.Dal.Migrations
{
    ...
    [Migration("20260925144240_GeoSeeds")]
    partial class GeoSeeds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmneziaGeo.Server.Dal.ApiTokenEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AmneziaGeo.Server.Dal.SeedEntity", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(32)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AmneziaGeo.Server.Dal.SubscriptionEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AmneziaGeo.Server.Dal.TrafficEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("SeenRx")
                        .HasColumnType("INTEGER");

                    b.Property<long>("SeenTx")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AmneziaGeo.Server.Dal.TrafficEntity", b =>
                {
                    b.HasOne("AmneziaGeo.Server.Dal.ClientEntity", null)
                        .WithMany()
